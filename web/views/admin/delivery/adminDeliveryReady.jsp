	                        ...
	                        <tr><th colspan="12">
                            	<div class="ui grid">
		                            <div class="ten wide column">
		                                ...
		                                <button class="ui black button" type="button" onclick="changeStateBtn(this);">배송대기중</button>
		                                <button class="ui black button" type="button" onclick="changeStateBtn(this);">배송중</button>
		                                <button class="ui grey button" type="button" onclick="changeStateBtn(this);">상품준비중</button>
		                                <button class="ui grey button" type="button" onclick="changeStateBtn(this);">취소신청</button>
		                                <button class="ui grey button" type="button" onclick="changeStateBtn(this);">교환신청</button>
		                            </div>
