	                        ...
	                        <tr><th colspan="12">
                            	<div class="ui grid">
		                            <div class="ten wide column">
		                                ...
		                                <button class="ui black button" type="button" onclick="changeStateBtn(this);">구매확정</button>
		                                <button class="ui grey button" type="button" onclick="changeStateBtn(this);">배송중</button>
		                                <button class="ui grey button" type="button" onclick="changeStateBtn(this);">교환신청</button>
		                                <button class="ui grey button" type="button" onclick="changeStateBtn(this);">반품신청</button>
		                                <button class="ui grey button" type="button" onclick="changeStateBtn(this);">환불신청</button>
		                            </div>
