...
/**
 * Servlet implementation class AdminAddressInputServlet
 */
@WebServlet("/adminAddressInput.de")
public class AdminAddressInputServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AdminAddressInputServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int result = new AdminDeliveryService().insertDeliveryInfo(de, orderDnums);
