               ...
               <table class="ui celled table">
                  ...
                  <tr>
                     ...
                     <div class="cartBtnDiv">
                        ...
                        &nbsp;&nbsp;
                        <button class="ui grey basic button cartBtn" onclick="wishListBtn();">♡WISH LIST</button>
                     </div>
         ...
         <div class="detailBottom1">
            ...
            <table class="ui brown table">
               ...
               <tbody>
                  <tr>
                     <td>1</td>
                     <td>색은 화면이랑 똑같이 딱 이쁜 브라운이에요~ 핏은 생각보다 여유가 있었어요.
            ...
            <table class="ui brown table">
               ...
               <tbody>
                  <tr>
                     ...
                     <button onclick="detailQnA();">클릭쓰</button></td>
                     <td>묭묭</td>
                     <td>2018-12-44</td>
                  </tr>
                  <tr>
