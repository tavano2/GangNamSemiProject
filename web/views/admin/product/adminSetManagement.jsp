...
<script src="https://unpkg.com/sweetalert/dist/sweetalert.min.js"></script>
  ...
  .checkbox();
    ...
    function issueSuccess(){
		swal("옵션세트 삭제 성공!", "확인 버튼을 눌러주세요.", "success")
		.then((value) => {	
			  location.reload();		
		});
	}
	function issueFail(){
		swal("옵션세트 삭제 실패!", "확인 버튼을 눌러주세요.", "success")
		.then((value) => {	
			  location.reload();		
		});
	}
    		...
    		$.ajax({
    			...
    			success:function(data){
    				...
    				for(var key in data){
    					...
    					var $inputTd = $("<td><input type='hidden' value='"+ data[key].optionSnum +"' name='optionCode1'>");
	...
	$(function(){
		$("#deleteOption").click(function(){
			...
			$.ajax({
				url:"/semi/deleteOptionSet.product",
				type:"post",
