	                        ...
	                        <tr><th colspan="12">
                            	<div class="ui grid">
		                            <div class="ten wide column">
		                                ...
		                                <button class="ui black button" type="button" onclick="changeStateBtn(this);">배송완료</button>
		                                <button class="ui grey button" type="button" onclick="changeStateBtn(this);">배송준비중</button>
		                                <button class="ui grey button" type="button" onclick="changeStateBtn(this);">배송대기중</button>
		                            </div>
