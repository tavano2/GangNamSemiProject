...
@WebServlet("/selectCustomerOrderDetail.de")
public class SelectCustomerOrderDetailServelt extends HttpServlet {
	private static final long serialVersionUID = 1L;
       

    public SelectCustomerOrderDetailServelt() {
        super();
    }
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
				...
				//가공전 리스트
				ArrayList<HashMap<String, Object>>list = new DeliveryService().selectDetailOrderList(lnum,userId);
